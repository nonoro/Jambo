...
import jambo.mvc.domain.user.Point;
...
public class QPoint extends EntityPathBase<Point> {
    ...
    private static final long serialVersionUID = -1544550651L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPoint point = new QPoint("point");

    public final NumberPath<Long> available_point = createNumber("available_point", Long.class);
