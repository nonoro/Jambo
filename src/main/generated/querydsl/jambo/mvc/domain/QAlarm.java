...
import jambo.mvc.domain.user.Alarm;
...
public class QAlarm extends EntityPathBase<Alarm> {
    ...
    private static final long serialVersionUID = -1558500410L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAlarm alarm = new QAlarm("alarm");

    public final EnumPath<AlarmState> alarmState = createEnum("alarmState", AlarmState.class);
